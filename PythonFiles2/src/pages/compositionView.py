...
def generateGraph(conn,graphistry_un,graphistry_pw):
    ...
    try:
        ...
        params = {"inputv.type": "master", "inputv": "0000001", "date1": "2015-01-15 00:00:00", "date2": "2015-01-15 00:00:00"}         
        q = conn.runInstalledQuery("getGraph_date", params)
